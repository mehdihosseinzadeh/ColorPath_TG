...
##load real data
os.chdir("/Users/mehdi/Desktop/python/ColorPath_TG/github/Real_Data") 
dataset = 'CollegeMsg_30color'
exec(open(dataset).read())
####### 
t1=time.time()
###%%% Try with optimal solution
#TS = deepcopy(TS_OP)
###%%%
n=[]
path=[]; path1_localSearch= []; del_nod=path
TS_current=deepcopy(TS) 
visited_color=[]; visited_color1_localSearch=[]
keys_TS = list(TS.keys())
current_time=-1   
epsilon=1*(round((len(keys_TS)+1)/(len(color_list))))
...
def local_search_edge(TS, path_edges_ts, col_map, path, visited_color, interval_span,path1_localSearch, visited_color1_localSearch):
  ...
  return path1_localSearch, visited_color1_localSearch, path_edges_ts_LS1,count_LS1
...
def local_search_node(TS, col_map,interval_span, path_edges_ts_LS1,path1_localSearch, visited_color1_localSearch):
    ...
    def  find_new_path_LS2(path_input,visited_color_input,path_edges_input,path_edges_ts_LS2,i_back,j,i):
     ...
     if j==0:
       ...
       if len(path_edges_ts_LS2)>1:
          tsPath_2=path_edges_ts_LS2[j+1]
       elif len(path_edges_ts_LS2)==1:
...
########################### 
    ...
    def LS2(path2_localSearch,visited_color2_localSearch,path_edges_input,path_edges_ts_LS2):
        ...
        for i in (path_edges_input):  
          ...
          if l==0:            
              ...
              path2_localSearch, path_edges_ts_LS2, visited_color2_localSearch,l, count_LS2=LS2(path2_localSearch,visited_color2_localSearch,path_edges_input,path_edges_ts_LS2)
        return path2_localSearch, path_edges_ts_LS2, visited_color2_localSearch,l, count_LS2
    ...
    return path2_localSearch, path_edges_ts_LS2, visited_color2_localSearch, count_LS2
...
if __name__ == '__main__':    
    ...
    if len(visited_color) < len(color_list):#if we havent found all the motifs
        print("LS1")
        path1_localSearch, visited_color1_localSearch, path_edges_ts_LS1, count_LS1 = local_search_edge(TS, path_edges_ts, col_map, path, visited_color, interval_span,path1_localSearch, visited_color1_localSearch)        
        t_LS1 = time.time()
        time_LS1=t_LS1-t_11
        if len(visited_color1_localSearch) < len(color_list):
           print("LS2")
           path2_localSearch, path_edges_ts_LS2, visited_color2_localSearch, count_LS2 = local_search_node(TS, col_map,interval_span, path_edges_ts_LS1,path1_localSearch, visited_color1_localSearch)
           t_LS2 = time.time()
           time_LS2=t_LS2-t_LS1
